...
//         const decodedToken = jwtDecode(token);
//         setUsername(decodedToken.Name);
//         axios.get("https://uzavan-server.onrender.com/Booking/Bookingview")
//           .then((response) => {
...
//             // Calculate counts
//             const pending = userBookings.filter((booking) => booking.isVerified === "Pending").length;
//             const accepted = userBookings.filter((booking) => booking.isVerified === "Accepted").length;
//             const cancelled = userBookings.filter((booking) => booking.isVerified === "cancelled").length;
...
//               <p className="TotalBooking">Total Bookings<br/> {bookings.length}</p>
...
//                         <>
//                           Accepted <FontAwesomeIcon icon={faCheckCircle} style={{ color: "green" }} />
//                         </>
//                       )}
//                       {booking.isVerified === "cancelled" && (
//                         <>
//                           Cancelled <FontAwesomeIcon icon={faTimesCircle} style={{ color: "red" }} />
//                         </>
//                       )}
//                       {booking.isVerified === "Pending" && (
//                         <>
//                           Pending <FontAwesomeIcon icon={faClock} style={{ color: "orange" }} />
//                         </>
//                       )}
//                     </td>
//                     <td>
