...
//         (machine) => machine.isVerified && machine.MachineryId === machine.MachineryId,
//       );
...
//   //   try {
//   //     const response = await fetch(`uzavan.vercel.app/profile/serviceView?userId=${userId}`);
//   //     const data = await response.json();
//   //     setUsers(data);
//   //   } catch (error) {
//   //     console.error("Failed to fetch users:", error);
...
//       try {
//         const response = await fetch(`uzavan.vercel.app/profile/service/${MachineryId}`);
//         if (!response.ok) {
